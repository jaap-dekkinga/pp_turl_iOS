...
public protocol DMSwipeCardsViewDelegate: AnyObject {
...
public class DMSwipeCardsView<Element>: UIView {
	...
	public init(frame: CGRect, viewGenerator: @escaping ViewGenerator, overlayGenerator: OverlayGenerator? = nil) {
